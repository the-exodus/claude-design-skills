---
description: Superseding an ADR whose status is a bare Status: line: the old one is marked in that field and otherwise untouched, the new one names it, the index follows.
tags: [adr]
