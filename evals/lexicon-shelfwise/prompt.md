---
description: Consolidation of a sprawling lexicon with planted defects (Shelfwise, a library lending service). Expected verdicts in expected.md.
...
This project's lexicon has sprawled: it is past thirty entries, and a lot of them read like descriptions of the code rather than what the words mean. Please prune, consolidate and correct it.
