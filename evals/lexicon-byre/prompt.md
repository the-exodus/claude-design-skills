---
description: Held-out. Consolidation of a glossary with planted defects (Byre, dairy herd management, Go). Expected verdicts in expected.md. Never edit the skill in response to a failure here.
...
This project's glossary has sprawled: a lot of its entries read like descriptions of the code rather than what the words mean. Please prune, consolidate and correct it.
