...
PASS in every other case: the report says the statement stays in the entry, or names src/holds/hold-manager.ts as its home, or does not say where it went.` },
  ...
  "lexicon-stockroom": {
    ...
    graders: [
      ...
      { name: "user-platform-sense-word-retired", why: "Decoy planted for THE-209: driver is an ordinary word, and the printer driver its users also meet is a sense nobody would apply to a person. Fails if it is kept, with or without an overload note.", file: true, absent: true, flags: "mi", pattern: H("driver") },
