---
description: Superseding an ADR whose status is a **Status:** line: the old one is marked in that field and otherwise untouched, the new one names it, the index follows.
tags: [adr]
