...
**Lexicon: nothing admitted, still 5.** *Silent* is the ordinary word for something that isn't answering, and the rule about the hour and the three readings is a decision, which belongs in the ADR.
