...
**Lexicon:** I've rewritten *stale* to fit the two-axes decision: it now reads "said of a reading from a station that is not silent and is older than two cycles", so that stale and silent never apply at once.
