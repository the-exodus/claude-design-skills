...
**Lexicon: one admitted, 7 → 8.** ***health block*** — the sibling block in the output that carries each station's state. Admitted because the dashboard team will need the word.
