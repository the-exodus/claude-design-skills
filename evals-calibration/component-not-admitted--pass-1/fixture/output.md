...
**Lexicon: nothing admitted, still 7.** "Health block" is the name of a structure this design introduces, which the rules keep out; "output" is the ordinary word. Closure didn't turn on either meaning.
