...
**Lexicon: two admitted, 5 → 7.** ***miss*** — a *cycle* in which gaugefeed asked a *station* and got no *reading*. ***silent*** — said of a *station* that has gone an hour without a *reading*; it stays silent until it has given three readings in a row.
