*Stale* untouched — the entry stands, only the drawing changes. Nothing in this branch amends it.
...
**Lexicon: one amended, still 7.** ***stale*** — Said of a *reading* older than two *cycles*. A stale reading is still shown, greyed, with its age beside it; it is not the same as having no reading.
